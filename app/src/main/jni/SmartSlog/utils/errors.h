...
enum sslog_errors {
    /* General errors */
    /** @defgroup SmartSlogErrorsGenerals Defines general errors. */
    ...
    /*@}*/ // Group ends: SmartSlogErrorsGenerals

    /* Errors for OWL-entities */
    /** @defgroup SmartSlogErrorsOWLEntities Defines errors for OWL entites. */
    ...
    /*@}*/ // Group ends: SmartSlogErrorsOWLEntities

    /* Cardinality errors */
    /** @defgroup SmartSlogErrorsCardinality Defines cardinality errors. */
    ...
    /*@}*/ // Group ends: SmartSlogErrorsCardinality

    /* Subscription errors */
    /** @defgroup SmartSlogErrorsSubscription Defines errors associated with subscription. */
    ...
    /*@}*/ // Group ends: SmartSlogErrorsSubscription

    /* Network errors (throws by KPI) */
    /** @defgroup SmartSlogErrorsNetwork Defines errors associated with network. */
    ...
    /*@}*/ // Group ends: SmartSlogErrorsNetwork
