 ...
 * @date    03 March, 2015
 * @brief   Describe ontology entites.
 *
 *
 * @section LICENSE
 *
 ...
 * @section DESCRIPTION
 *
 * Describe ontology entities (class, property. individual).
 *
...
/** @brief Types of actions performed under triples/entites. */
 ...
 * When the triples is deleted, then deleted linked with this triples entity too.
 * @see sslog_class_t
